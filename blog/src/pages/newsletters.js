        ...
        <h1 className='author__site-title'>Newsletters Archive</h1>
		  ...
		  <Box
			 ...
			 sx={{
				...
				<Image src={"../Jan2022_cover.png"} />
				<Heading>January 2022</Heading>
				<Text color='#111'>Issue 24</Text>
			 </Card>
			 </a>
			 <a href="/">
			 <Card width={256}
			 ...
			 sx={{
				...
				<Image src={"../July-2021.jpeg"} />
				<Heading>July 2021</Heading>
